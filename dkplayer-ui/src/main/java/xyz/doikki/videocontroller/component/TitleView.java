...
public class TitleView extends FrameLayout implements IControlComponent {
    ...
    public static ImageView xc; //小窗
    public static ImageView tp; //投屏
    public static ImageView sz; //设置
...

    {
        ...
        xc=findViewById(R.id.xiaochuang); //小窗按钮
        ...
        tp=findViewById(R.id.touping); //投屏按钮
        ...
        sz=findViewById(R.id.shezhi); //设置按钮
    ...
    private static OnWindowClickListener onwindow;
    public static void setOnWindowClickListener(OnWindowClickListener onWindowClickListener){
    ...
    private static OnScreenClickListener onscreen;
    public static void setOnScreenClickListener(OnScreenClickListener onScreenClickListener){
    ...
    private static OnSetClickListener onset;
    public static void setOnSetClickListener(OnSetClickListener onSetClickListener){
        onset=onSetClickListener;
    }
